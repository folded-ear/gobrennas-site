...
Completed systematic audit of [file/component path] following react-testing standards. Identified [N] test quality issues across [N] severity levels. [Brief description of what this component does and why user-centric, accessible tests matter here].
